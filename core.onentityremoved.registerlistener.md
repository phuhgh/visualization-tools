...
```typescript
static registerListener<TRequiredTraits>(owner: IReadonlyPlot<unknown, TRequiredTraits> | IChartComponent<TUnknownRenderer>, onEvent: (...args: TEntityRemovedArgs<TRequiredTraits>) => void): () => void;
```
