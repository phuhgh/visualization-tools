 ...
 */
export class GlTrace2dNaturalLogTransformComponent
    implements IGlTransformComponent<TGl2ComponentRenderer, IGlTraceBinder, ICartesian2dUpdateArg<Float32Array>, unknown>
{
    public static factory = new GlTransformComponentFactory(Cartesian2dNaturalLogTransform.transformId, TraceBinderIdentifier, GlTrace2dNaturalLogTransformComponent);
