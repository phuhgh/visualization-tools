    ...
    implements ICartesian2dUpdateArgProvider<Float64Array, TRequiredTraits>
{
    ...
    private readonly reverseWholeRange = new Range2d.f32();
    private readonly reverseInteractiveRange = new Range2d.f32();
    private readonly updateArg = new Cartesian2dUpdateArg(Float64Array);
}
