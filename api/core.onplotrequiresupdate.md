...
|  [onPlotRequiresUpdate](./core.onplotrequiresupdate.onplotrequiresupdate.md) |  | (plot: [IReadonlyPlot](./core.ireadonlyplot.md)<!-- -->&lt;[IPlotRange](./core.iplotrange.md)<!-- -->, unknown&gt;, updateFlag: [EEntityUpdateFlag](./core.eentityupdateflag.md)<!-- -->) =&gt; void |  |
